...
$$P(X> 2, Y\leq 1)=\pi_{3,0}+\pi_{3,1}=0.233$$
...
$$f(y)=\int_0^2 \frac{x}{8} dx=\frac{1}{4}; \quad 0\leq y \leq 4$$
Notar que:

$$f(x)*f(y)=\frac{x}{2}*\frac{1}{4}=\frac{x}{8}=f(x,y)$$

Nota: Si el producto de las marginales da la densidad conjunta, las variables son independientes.
...
Esto sucede únicamente cuando las variables son independientes
...
$$E[Y]=\int_0^2 y\left( \frac{1}{3}+\frac{y}{6} \right)dx=\frac{10}{9}$$
...
$$f(X_1,X_2,\ldots,X_n)=\int_{Rx_1}\int_{Rx_2}\ldots \int_{Rx_n}f(X_1,X_2,\ldots,X_n)dx_n\ldots dx_2dx_1=1$$
