...
Tarea: Calcular la correlación del ejercicio anterior.  
...
Tarea
  ...
  * Encontrar una W para el ejercicio anterior, que permita encontrar la función de densidad de $Z$ (Recomendación $W=X/Y$)
  * Sea $X$ y $Y$ variables aleatorias independientes, cada una con la misma distribución exponencial. Encuentre la función de densidad de $Z=X/Y$, Recomendación $W=X+Y$
