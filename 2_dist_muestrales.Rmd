...
$$\hat{\theta}_1=\hat{t}_y=\frac{(\sum_s y_i)^2}{7}$$
$$\hat{\theta}_2=n*\sum_s y_i-25$$

$$\hat{\theta}_3=\frac{N \sum_s y_i}{n}=N*\bar{y}$$
$$\hat{\theta}_4=\hat{t}_y=\sum_s y_i$$
...
$$\hat{S}^2_x=99.35833$$
Usando el teorema del limite central, podemos decir (aproximar) que:
...
Viendo los resultados en una simulación
