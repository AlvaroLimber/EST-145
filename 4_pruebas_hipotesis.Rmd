...
Tarea: Investigar que es el efecto mínimo detectable, el efecto de tamaño. Y encontrar valores recomendados. 

Nota: La siguiente clase se realizará la demostración para el tamaño de muestra para la media. El estudiante debe repasar los tamaños de muestra para la proporción y la diferencia de medias y proporciones. 
